        ...
        <div className="bg-volt-deep border-b border-border">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
            ...
            {activeCategory?.description && (
              <p className="mt-2 text-volt-muted max-w-2xl">
                {activeCategory.description}
              </p>
            )}
          </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <Sheet open={filtersOpen} onOpenChange={setFiltersOpen}>
                <SheetTrigger asChild>
                  <Button 
                    variant="outline" 
                    className="lg:hidden border-border text-volt-white hover:bg-volt-panel"
                  >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    viewMode === 'grid' 
                      ...
                      : 'text-volt-muted hover:text-volt-white'
                  )}
                >
            ...
            <div className="flex-1">
              {filteredProducts.length === 0 ? (
                <div className="text-center py-16">
                  ...
                  <Button
                    variant="outline"
                    className="mt-4 border-border text-volt-white hover:bg-volt-panel"
                    onClick={clearFilters}
                  >
                    Clear filters
                  </Button>
