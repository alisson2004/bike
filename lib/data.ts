...
Features optimized for delivery riders include phone mount integration, USB charging port, bright LED lights visible from all angles, and a loud horn for urban navigation. The low step-through frame makes frequent mounting and dismounting effortless.`,
  ...
  // Parts (placeholder inventory to populate /products)
  {
    id: 'part-frame',
    sku: 'VINXS-FRAME-001',
    name: 'Frame Upgrade Kit',
    slug: 'frame-upgrade-kit',
    description: 'Frame upgrade kit for Vinxs Bikes. Designed for reliable fit and smooth rides.',
    shortDesc: 'Frame upgrade kit for Vinxs Bikes.',
    status: 'IN_STOCK',
    ...
    images: [
      { id: 'img-part-frame-1', url: '/equipamentos/Screenshot%202025-12-27%20232734.png', altText: 'Frame upgrade', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-frame-1', label: 'Material', value: 'Alloy', unit: '', sortOrder: 1 },
      { id: 'spec-part-frame-2', label: 'Fit', value: 'Vinxs', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-wheel',
    ...
    name: 'Wheel Set',
    slug: 'wheel-set',
    description: 'Replacement wheel set for Vinxs Bikes.',
    shortDesc: 'Replacement wheel set for Vinxs Bikes.',
    status: 'IN_STOCK',
    categoryId: 'cat-wheel',
    priceRetail: 199,
    priceWholesale: 149,
    compareAt: 229,
    stock: 18,
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-wheel-1', url: '/equipamentos/original__4_-removebg.png', altText: 'Wheel set', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-wheel-1', label: 'Type', value: 'Wheel', unit: '', sortOrder: 1 },
      { id: 'spec-part-wheel-2', label: 'Use', value: 'Daily', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-tires',
    ...
    name: 'Tires & Tube Set',
    slug: 'tires-tube-set',
    description: 'Tires and tube set for smoother grip and control.',
    shortDesc: 'Tires and tube set.',
    status: 'IN_STOCK',
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-tires-1', url: '/equipamentos/Screenshot%202025-12-27%20232734.png', altText: 'Tires', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-tires-1', label: 'Compound', value: 'Grip', unit: '', sortOrder: 1 },
      { id: 'spec-part-tires-2', label: 'Set', value: 'Tire+Tube', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-brakes',
    sku: 'VINXS-BRAKES-001',
    name: 'Brake Pads (Set)',
    slug: 'brake-pads-set',
    description: 'Replacement brake pads for consistent stopping power.',
    shortDesc: 'Brake pads replacement set.',
    status: 'IN_STOCK',
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-brakes-1', url: '/equipamentos/Screenshot%202025-12-27%20233417.png', altText: 'Brake pads', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-brakes-1', label: 'Brake', value: 'Pad', unit: '', sortOrder: 1 },
      { id: 'spec-part-brakes-2', label: 'Use', value: 'Urban', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-suspention',
    ...
    slug: 'suspension-service-kit',
    description: 'Suspension service kit for better comfort and control.',
    shortDesc: 'Suspension service kit.',
    status: 'IN_STOCK',
    categoryId: 'cat-suspention',
    priceRetail: 149,
    priceWholesale: 109,
    compareAt: 179,
    stock: 12,
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-suspention-1', url: '/equipamentos/Screenshot%202025-12-27%20233632.png', altText: 'Suspension kit', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-suspention-1', label: 'Service', value: 'Kit', unit: '', sortOrder: 1 },
      { id: 'spec-part-suspention-2', label: 'Focus', value: 'Comfort', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-mudguards',
    sku: 'VINXS-MUDGUARD-001',
    name: 'Mudguards Set',
    slug: 'mudguards-set',
    description: 'Mudguards set to keep you and your bike cleaner on wet days.',
    shortDesc: 'Mudguards set.',
    status: 'IN_STOCK',
    categoryId: 'cat-mudguards',
    priceRetail: 39,
    priceWholesale: 29,
    compareAt: 49,
    stock: 22,
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-mudguards-1', url: '/equipamentos/Screenshot%202025-12-27%20232734.png', altText: 'Mudguards', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-mudguards-1', label: 'Protection', value: 'Splash', unit: '', sortOrder: 1 },
      { id: 'spec-part-mudguards-2', label: 'Mount', value: 'Quick', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-keys',
    ...
    name: 'Key & Lock Set',
    slug: 'key-lock-set',
    description: 'Replacement key and lock set for your Vinxs Bike.',
    shortDesc: 'Replacement key & lock set.',
    status: 'IN_STOCK',
    categoryId: 'cat-keys',
    priceRetail: 19,
    priceWholesale: 14,
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-keys-1', url: '/equipamentos/Screenshot%202025-12-27%20234056.png', altText: 'Keys and lock', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-keys-1', label: 'Set', value: '2 keys', unit: '', sortOrder: 1 },
      { id: 'spec-part-keys-2', label: 'Type', value: 'Lock', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-saddle',
    sku: 'VINXS-SADDLE-001',
    name: 'Seat & Seatpost Components',
    slug: 'seat-seatpost-components',
    description: 'Seat and seatpost component set for smoother riding.',
    shortDesc: 'Seat & seatpost components.',
    status: 'IN_STOCK',
    categoryId: 'cat-saddle',
    priceRetail: 49,
    priceWholesale: 36,
    compareAt: 59,
    stock: 16,
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-saddle-1', url: '/equipamentos/Screenshot%202025-12-27%20235416.png', altText: 'Saddle', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-saddle-1', label: 'Fit', value: 'Seatpost', unit: '', sortOrder: 1 },
      { id: 'spec-part-saddle-2', label: 'Use', value: 'Comfort', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-chain',
    ...
    slug: 'chain-replacement',
    description: 'Chain replacement for dependable drivetrain performance.',
    shortDesc: 'Chain replacement.',
    status: 'IN_STOCK',
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-chain-1', url: '/equipamentos/Screenshot%202025-12-27%20235716.png', altText: 'Chain', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-chain-1', label: 'Drive', value: 'Chain', unit: '', sortOrder: 1 },
      { id: 'spec-part-chain-2', label: 'Quality', value: 'Durable', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-freewheel',
    sku: 'VINXS-FREEWHEEL-001',
    name: 'Freewheel Component',
    slug: 'freewheel-component',
    description: 'Freewheel component replacement for smooth shifting.',
    shortDesc: 'Freewheel component.',
    status: 'IN_STOCK',
    categoryId: 'cat-freewheel',
    priceRetail: 59,
    priceWholesale: 44,
    compareAt: 69,
    stock: 10,
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-freewheel-1', url: '/equipamentos/Screenshot%202025-12-27%20235716.png', altText: 'Freewheel', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-freewheel-1', label: 'Type', value: 'Freewheel', unit: '', sortOrder: 1 },
      { id: 'spec-part-freewheel-2', label: 'Smoothness', value: 'High', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-headset',
    sku: 'VINXS-HEADSET-001',
    name: 'Headset Bearing Set',
    slug: 'headset-bearing-set',
    description: 'Headset bearing set to restore steering smoothness.',
    shortDesc: 'Headset bearing set.',
    status: 'IN_STOCK',
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-headset-1', url: '/equipamentos/Screenshot%202025-12-27%20235716.png', altText: 'Headset', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-headset-1', label: 'Use', value: 'Steering', unit: '', sortOrder: 1 },
      { id: 'spec-part-headset-2', label: 'Feel', value: 'Smooth', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-eletric',
    sku: 'VINXS-ELEC-001',
    name: 'Electric Components Pack',
    slug: 'electric-components-pack',
    description: 'Replacement electric components for bikes (placeholder item).',
    shortDesc: 'Electric components pack.',
    status: 'IN_STOCK',
    categoryId: 'cat-eletric',
    priceRetail: 99,
    priceWholesale: 74,
    compareAt: 129,
    stock: 9,
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-eletric-1', url: '/equipamentos/Screenshot%202025-12-27%20233734.png', altText: 'Electric components', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-eletric-1', label: 'Pack', value: 'EC', unit: '', sortOrder: 1 },
      { id: 'spec-part-eletric-2', label: 'Use', value: 'E-bike', unit: '', sortOrder: 2 },
    ],
  },
  {
    id: 'part-assessories',
    ...
    description: 'Accessories bundle to upgrade your ride (placeholder item).',
    shortDesc: 'Accessories bundle.',
    status: 'IN_STOCK',
    categoryId: 'cat-assessories',
    priceRetail: 25,
    priceWholesale: 18,
    compareAt: 35,
    stock: 60,
    ...
    updatedAt: new Date('2026-03-09'),
    images: [
      { id: 'img-part-assessories-1', url: '/equipamentos/Screenshot%202025-12-27%20234335.png', altText: 'Accessories', sortOrder: 1, isPrimary: true },
    ],
    specs: [
      { id: 'spec-part-assessories-1', label: 'Bundle', value: 'Set', unit: '', sortOrder: 1 },
      { id: 'spec-part-assessories-2', label: 'Category', value: 'Add-ons', unit: '', sortOrder: 2 },
    ],
  },
]
